...
exports.updateMedication = async (req, res) => {
    try {
        const { Medication } = req.models;
        const { id } = req.params;
        const updatedMedication = await Medication.findOneAndUpdate({ id }, req.body, { new: true });
...
exports.deleteMedication = async (req, res) => {
    try {
        const { Medication } = req.models;
        const { id } = req.params;
        const deletedMedication = await Medication.findOneAndDelete({ id });
